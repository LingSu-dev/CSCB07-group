...
import com.b07.exceptions.InvalidAccessException;
import com.b07.exceptions.InvalidInsertException;
...
public class SalesApplication {
  ...
  public static void firstTimeSetup(Connection connection) 
    ...
    } catch (InvalidInsertException | InvalidAccessException e) {
      System.out.println("Something went wrong when creating administrator account");
    ...
    try {
      ...
      System.out.println("Something went wrong when creating Employee account");
      System.out.println("Database Creation was unsuccessfull");
      e.printStackTrace();
      exitOnFailure(connection);
    }
    ...
    while (!exit) {
      ...
      if (input.equals("1")) {
        ...
        try {
          ...
          System.out.println("Could not create new customer");
          System.out.println("Something went wrong while adding a new customer");
        }
        ...
        try {
          ...
          System.out.println("Could not create new employee");
          System.out.println("Invalid input:");
          System.out.println(e.getMessage());
        } catch (NumberFormatException e) {
          System.out.println("Could not create new customer");
    ...
    while (!exit) {
      ...
      if (input.equals("1")) {
        ...
        try {
          ...
          System.out.println("Adding failed, no such item");
        }
