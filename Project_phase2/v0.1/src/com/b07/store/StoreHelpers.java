...
public class StoreHelpers {
   ...
   */
  public static final User login(Roles role, int id, String password) throws SQLException, DatabaseInsertException, ConnectionFailedException {
   ...
   * @throws IOException 
   */
  public static int choiceDialog(String[] choices, BufferedReader reader) throws IOException {
